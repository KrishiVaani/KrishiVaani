...
# CUDA_VISIBLE_DEVICES=0 python /workspace/username/krishivaani_inferences/outofdomain_inferences/inference.py
...
for x in range(len(processing_folders)):
    ...
    output_csv = "/workspace/username/krishivaani_inferences/outofdomain_inferences/inferences/byt5-base/" + os.path.basename(mod_) + "_Ourmodel.csv"
    ...
    if os.path.exists(output_csv):
        ...
        input_csv = "/workspace/username/krishivaani_inferences/outofdomain_inferences/OutofDomain_new.csv"
