...
for x in range(len(processing_folders)):
    ...
    output_csv = "/workspace/username/krishivaani_inferences/krishivaani_unknown/filtered_inferences/byt5-base/broken_" + os.path.basename(mod_) + "_Ourmodel.csv"
    ...
    if os.path.exists(output_csv):
        ...
        input_csv = "/workspace/username/krishivaani_inferences/krishivaani_unknown/broken_krishivaani_unknown.csv"
