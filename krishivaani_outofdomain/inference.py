...
# CUDA_VISIBLE_DEVICES=5 python /workspace/username/krishivaani_inferences/outofdomain_filter_inferences/inference.py

folder_path = "/workspace/username/LM/byt5-base"
...
for x in range(len(processing_folders)):
    ...
    model_path = f"/workspace/username/LM/byt5-base/{mod_}/model"
    tokenizer_path = f"/workspace/username/LM/byt5-base/{mod_}/tokenizer"
    
    if not os.path.exists(model_path):
        model_path = f"/workspace/username/LM/byt5-base/{mod_}"
        tokenizer_path = model_path

    output_csv = "/workspace/username/krishivaani_inferences/outofdomain_filter_inferences/filter_inferences/byt5-base/broken_" + os.path.basename(mod_) + "_Ourmodel.csv"
    ...
    if os.path.exists(output_csv):
        ...
        input_csv = "/workspace/username/krishivaani_inferences/outofdomain_filter_inferences/broken_krishivaani_outofdomain_filtered.csv"
